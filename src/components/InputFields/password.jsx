...
export const Password = ({name,onChange,value,onClick,show}) => {
  return (
    <div className="mb-6">
        <label for="password" classNae="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
